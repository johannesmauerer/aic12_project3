...
public class Test
{
//	private static String host = "http://128.130.172.202:8080";
...
//    	WebResource resource = client.resource(host + "/dao/tweetdao/getnumberoftweetforrequest");
//    	System.out.println(resource.accept(MediaType.APPLICATION_JSON).type(MediaType.APPLICATION_JSON).post(Long.class, request));
    	WebResource resource = client.resource(host + "/dao/tweetdao/getallforrequest");
    	System.out.println(resource.accept(MediaType.APPLICATION_JSON).type(MediaType.APPLICATION_JSON).post(TweetList.class, request).getList());
    }
}
